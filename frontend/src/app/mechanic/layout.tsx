...
export default function MechanicLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    { href: '/mechanic/orders', label: 'Órdenes Asignadas', icon: Wrench },
  ];
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-black text-gray-900 dark:text-gray-100 flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 flex flex-col">
        <div className="p-6 border-b border-gray-200 dark:border-gray-800">
          ...
          <p className="text-xs text-gray-500 font-medium tracking-widest uppercase mt-1">Portal Mecánico</p>
        </div>
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-800">
          <Link href="/login" className="flex w-full items-center px-4 py-3 text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-colors">
